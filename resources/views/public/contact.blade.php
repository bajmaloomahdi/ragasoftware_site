    ...
    @else
        <section class="section-pad">
            <div class="container-site grid gap-12 lg:grid-cols-2">
                <div>
                    <h1 class="text-3xl font-extrabold text-navy-900 sm:text-4xl">با ما در تماس باشید</h1>
                    ...
                    @if($map = $site->get('contact.map_embed'))
                        <div class="mt-8 overflow-hidden rounded-2xl border border-mist-200">{!! $map !!}</div>
                    @endif
                </div>
                <div>
