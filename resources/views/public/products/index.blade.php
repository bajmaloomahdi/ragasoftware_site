...
@section('content')
    ...
    <div class="container-site section-pad">
        <div class="max-w-2xl">
            <h1 class="text-3xl font-extrabold text-ink-900 sm:text-4xl">محصولات و راهکارهای راگا سافت‌ور</h1>
            <p class="mt-4 lead">
        ...
        @if($products->isEmpty())
            <p class="mt-12 text-ink-500">به‌زودی محصولات اضافه می‌شوند.</p>
        @else
